...
| Q8 | **"The AI noticed…" is shown only on a reshoot or reject decision**, never on an approved Assessment, for V2 (V2-Q20 narrowed). *Note (2026-09-26): superseded by D-59 (shown after every decision, with evidence and plain-text timestamps).* | D-52 |
