...
3. **How many Brev credits does each team get?** This is announced on Sunday. *Affects whether 2B runs in the eval.*
4. **What is the exact Nemotron model id** on build.nvidia.com on the day?
