...
// Every protected page must also call auth.protect() itself (Clerk deprecated
// createRouteMatcher-based gating in favour of resource checks), so this list
// is a UX redirect, never the only guard.
