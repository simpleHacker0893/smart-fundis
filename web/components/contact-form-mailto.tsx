...
/**
 * The mailto fallback of the contact form (#24), used only when the build has
 * no Convex URL (#29). Submitting opens the visitor's email app with the
 * message filled in: the button says so, and nothing is sent by us.
 */
export function MailtoContactForm({ to }: { to: string }) {
